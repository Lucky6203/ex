...
<body>
    ...
    <header class="header">
        ...
        <nav class="navbar active" id="navbar">
            ...
            <ul>
                ...
                <li> <a href="#contact" style="--1:4">Contact</a></li>
            </ul>
        </nav> <!-- 
    ...
    <section class="home" id="home_id">
        <div class="home-content">
            ...
            <div class="home-sci">
                <a href="#" style="--1:5"><i class="fa-brands fa-linkedin"></i></a>
                <a href="#" style="--1:6"><i class="fa-brands fa-github"></i></a>
                <a href="#" style="--1:7"><img
                        src="https://www.elevatorandlifts.com/wp-content/uploads/2024/03/Ground-Up-Logo-Up-Symbol-Only-1.png"
                        alt="Freelancering icon" style="height: 28px;width: 28px;">
                </a>
    ...
    <section id="serivicse_id">
        ...
        <div class="container">
            ...
            <div class="serivices-list">
                ...
                <div class="web_services">
                    <img src="https://iconape.com/wp-content/png_logo_vector/uipath.png" alt="RPA icon"
                        class="rpa_icon">
                ...
                <div class="web_services">
                    <img src="https://www.elevatorandlifts.com/wp-content/uploads/2024/03/Ground-Up-Logo-Up-Symbol-Only-1.png"
                        alt="Freelancering icon" class="rpa_icon">
                    <h2 class="heading_services">Freelancer</h2>
                    <p class="pairagraf_seriviese">
                        This involves creating and maintaining websites. Web developers work with various programming
                        languages like HTML, CSS, JavaScript,
                        and frameworks like React, Angular, or Vue.js. They build websites from scratch or enhance
                        existing ones
    ...
    <section class="contact_us" id="contact">
        ...
        <div class="contact_about">
            ...
            <p class="contact_info">Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe, eius consequuntur ad dolores qui nemo
                doloremque </p>

            <div class="prsnol_contact">

                <div class="prsonol_eamil">
                    <P><i class="fa-solid fa-square-envelope fa-rotate-180" style="color: #0ef;"></i>  lk502295@gmail.com
                    </P>
                </div>


                <div class="prsonol_call">
                    <p> <i class="fa-solid fa-phone" style="color: #0ef;"></i> 6203708517</p>
            ...
            <div class="contact_from">
                <div class="contact_item">
                    <form method="post" action="">
                        ...
                        <input type="email" id="email" name="email"  placeholder="Enter You mail"><br><br>

                        <textarea id="message" name="message" rows="4" placeholder="Write a message" required></textarea><br>
